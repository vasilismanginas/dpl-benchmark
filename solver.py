...
class Solver(object):
    ...
    def solve(self, batch: Sequence[Query]) -> List[Result]:
        ...
        #this line is for caching the previous predicate, which is used in the next iteration
        #it was added as a modification, not part of original source code
...
#save the previous predicate to a file
